...
# 云端 API 示例：
  MODEL_CONFIGS["gpt-5.4-judge"] = ModelConfig(
      url="https://openai.drawthings.cn/v1",
      model_name="gpt-5.4",
      api_key=os.environ.get("OPENAI_API_KEY", "sk-4d933e2d8269ddb4f654ec37fc7e020652b37da7915babba4053837bf07e84da"),
  )

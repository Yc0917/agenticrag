...
# Agent 推理模型（环境变量覆盖）
AGENT_LLM_MODEL = os.environ.get("AGENT_LLM_MODEL", "gpt-5.4")
# Prompt 语言：en / zh
PROMPT_LANG = os.environ.get("PROMPT_LANG", "zh")
# 评测 Judge 用
JUDGE_LLM_MODEL = os.environ.get("JUDGE_LLM_MODEL", "gpt-5.4")
# 数据合成用
SYNTH_LLM_MODEL = os.environ.get("SYNTH_LLM_MODEL", "gpt-5.4")
